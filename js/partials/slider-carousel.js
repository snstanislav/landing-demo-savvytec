document.addEventListener("DOMContentLoaded", () => {
    ...
    const positions = [
        { x: -350, y: -100, scale: 0.5, z: -200, zIndex: 2, opacity: 1 }, // Left background
        { x: 0, y: 50, scale: 1, z: 0, zIndex: 3, opacity: 1 },           // Center front
        { x: 350, y: -100, scale: 0.5, z: -200, zIndex: 1, opacity: 0.7 } // Right background
    ];
